...
get_header(); ?>
	...
	<div id="primary" class="content-area">
      ...
      <section class="hero-banner">
          <img class="mobile-banner" src="<?php the_field('mobile_img'); ?>" alt="">
          <video class="video-banner" autoplay="" loop="" preload="" muted="">
            <source src="<?php the_field('hero_img'); ?>" type="video/mp4">      
          </video>
          <div class="hero-content">
            <img class="center-img" src="<?php the_field('center_img'); ?>" alt="">
          </div>
      </section>
      
      <section id="about">
        <div class="about-content">
          <img class="about-logo" src="<?php the_field('about_img'); ?>" >
          <h1><?php the_field('about_title'); ?></h1>
          <p><?php the_field('about_text'); ?></p>
          <div class="about-content-images">
            <img class="about-img1" src="<?php the_field('about_image_sub1'); ?>" >
            <img class="about-img2" src="<?php the_field('about_image_sub2'); ?>" >
            <img class="about-img3" src="<?php the_field('about_image_sub3'); ?>" >
          </div>
        </div>
      </section>
      <section id="menu">
